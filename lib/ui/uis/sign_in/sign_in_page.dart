...
import 'package:flutter_base_bloc/ui/uis/sign_in/sign_in_cubit.dart';
import 'package:flutter_base_bloc/ui/widgets/buttons/app_white_button.dart';
import 'package:flutter_base_bloc/ui/widgets/input/app_email_input.dart';
import 'package:flutter_base_bloc/ui/widgets/input/app_password_input.dart';
...
class _SignInPageState extends State<SignInPage> {
  final _usernameTextController =
      TextEditingController(text: 'thoson.it@gmail.com');
      ...
      builder: (context, state) {
        ...
        return Container(
          ...
          child: AppWhiteButton(
            title: 'Sign In',
            onPressed: isLoading ? doNothing : _signIn,
            isLoading: isLoading,
          ),
        );
      },
