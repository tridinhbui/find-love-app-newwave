...
import 'package:flutter_base_bloc/database/share_preferences_helper.dart';
...
class SecureStorage {
  ...
  static final SecureStorage _singleton =
      SecureStorage._internal(FlutterSecureStorage());
  ...
  void saveToken(TokenEntity token) async {
    if (token == null) {
      ...
      await _storage.write(
          key: _apiTokenKey, value: jsonEncode(token.toJson()));
